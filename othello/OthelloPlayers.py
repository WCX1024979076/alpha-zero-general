...
def fetch(matchClass):
    req = urllib.request.Request("https://botzone.org.cn/api/6660829299c3764322c03644/7626269734/localai")
    ...
    def play(self, board):
        while True:
            ...
            for mid, m in matches.items():
                ...
                tmp = json.loads(m.current_request)
                a = self.game.n * tmp["y"] + tmp["x"] if tmp["x"] != -1 else self.game.n ** 2
                return a
